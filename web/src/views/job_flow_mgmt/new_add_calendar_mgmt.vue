        ...
        <bk-form :label-width="100" :model="form" ref="form" :rules="rules">
            <bk-form-item label="日历名" :required="true" :error-display-type="'normal'" :property="'name'">
                <div class="upload-wrap">
                    ...
                    <bk-button theme="primary" @click="handleChooseFile" class="upload-btn">导入</bk-button>
            ...
            <bk-form-item label="快速设置">
                <bk-checkbox :disabled="disabled">周末</bk-checkbox>
                <bk-checkbox style="margin-left: 16px;" :disabled="disabled">工作日</bk-checkbox>
            </bk-form-item>
...
<script>
    ...
    import { getYearWeekDay } from '../../common/date.js'
    export default {
        components: {
            calendar
        },
