    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_id', models.UUIDField(blank=True, default=uuid.uuid4, editable=False, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Genre',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mbz_track_id', models.CharField(blank=True, default='', max_length=255, null=True)),
                ('mbz_album_id', models.CharField(blank=True, default='', max_length=255, null=True)),
                ('mbz_artist_id', models.CharField(blank=True, default='', max_length=255, null=True)),
                ('mbz_album_artist_id', models.CharField(blank=True, default='', max_length=255, null=True)),
                ('mbz_album_type', models.CharField(blank=True, default='', max_length=255, null=True)),
                ('mbz_album_comment', models.CharField(blank=True, default='', max_length=255, null=True)),
                ('mbz_release_track_id', models.CharField(blank=True, default='', max_length=255, null=True)),
